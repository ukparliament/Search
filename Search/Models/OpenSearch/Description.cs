namespace OpenSearch
{
    ...
    public class Description
    {
        ...
        {
            get => Description.RequiredElementValue(this.shortName);
            set
            {
        ...
        {
            get => Description.RequiredElementValue(this.descriptionText);
            set
            {
        ...
        [XmlIgnore]
        public Collection<CultureInfo> Languages { get; } = new Collection<CultureInfo>();
        ...
        [XmlIgnore]
        public Collection<Encoding> InputEncodings { get; } = new Collection<Encoding>();
        ...
        [XmlIgnore]
        public Collection<Encoding> OutputEncodings { get; } = new Collection<Encoding>();
        ...
        private static void ValidateRequired(string value)
        {
            if (value == null)
            {
                throw new ArgumentNullException(nameof(value), "This element must appear exactly once.");
            }
        }
        ...
        private static void ValidateEmail(string value)
        {
            ...
            {
                throw new FormatException("The value must conform to the requirements of Section 3.4.1 'Addr - spec specification' in RFC 2822.", e);
            }
        }
